...
configs:
- config_name: default
  data_dir: mmu_cfa_seccsn/dataset
tags:
- astronomy
license: cc-by-4.0
pretty_name: mmu_cfa_seccsn
size_categories:
- n<1K
---
...
- [`collection.properties`](https://huggingface.co/datasets/UniverseTBD/mmu_cfa_seccsn/collection.properties) � textual metadata file describing the HATS collection of catalogs
- [`mmu_cfa_seccsn`](https://huggingface.co/datasets/UniverseTBD/mmu_cfa_seccsn/mmu_cfa_seccsn) � main HATS catalog directory
  - [`dataset/`](https://huggingface.co/datasets/UniverseTBD/mmu_cfa_seccsn/mmu_cfa_seccsn/dataset/) � Apache Parquet dataset directory for the main catalog
    - ... parquet metadata and data files in sub directories ...
  - [`hats.properties`](https://huggingface.co/datasets/UniverseTBD/mmu_cfa_seccsn/mmu_cfa_seccsn/hats.properties) � textual metadata file describing the main HATS catalog
  - [`partition_info.csv`](https://huggingface.co/datasets/UniverseTBD/mmu_cfa_seccsn/mmu_cfa_seccsn/partition_info.csv) � CSV file with a list of catalog HEALPix tiles (catalog partitions)
  - [`skymap.fits`](https://huggingface.co/datasets/UniverseTBD/mmu_cfa_seccsn/mmu_cfa_seccsn/skymap.fits) � HEALPix skymap FITS file with row-counts per HEALPix tile of fixed order 10
- [`mmu_cfa_seccsn_10arcs/`](https://huggingface.co/datasets/UniverseTBD/mmu_cfa_seccsn/mmu_cfa_seccsn_10arcs) � default margin catalog to ensure data completeness in cross-matching, the margin threshold is 10.0 arcseconds
